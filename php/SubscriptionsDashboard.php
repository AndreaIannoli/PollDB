...
<head>
    ...
    <title>PollDB - Subscription Dashboard</title>
            ...
            <form class="row justify-content-center gap-1" style="max-height: 250px; overflow-y: scroll;" method="post">
                <?php
                    ...
                    for($x=0; $x<sizeof($premiums); $x++){
                        ...
                        $premiumEnd = $premiums[$x]['FineAbbonamento'];
                        $premiumCost = $premiums[$x]['Costo'];
                        ...
                        echo("
                            ...
                            .$premiumName.'<br> Fine:'.$premiumEnd.' Costo:'.$premiumCost.
